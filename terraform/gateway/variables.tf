...
variable "gateway_ami_id" {
  description = "Approved immutable Ubuntu Server 26.04 LTS ARM64 gateway AMI ID."
  type        = string
...
variable "gateway_instance_type" {
  description = "Approved ARM instance type for the gateway appliance."
  type        = string
  default     = "t4g.small"

  validation {
    condition     = var.gateway_instance_type == "t4g.small"
    error_message = "The accepted gateway appliance size is t4g.small."
  }
}
